...
export default {
  ...
  hikaye: {
    ...
    sureAciklama: 'Hikâyen 24 saat boyunca arkadaşlarına görünür.',
    paylas: 'Paylaş',
    paylasiliyor: 'Paylaşılıyor…',
    paylasildi: 'Hikâyen paylaşıldı',
    mesajGonder: 'Mesaj gönder',
    yanitYerTutucu: 'Yanıt yaz…',
    yanitOnEki: 'Hikâyene yanıt:',
    yanitGonderildi: 'Yanıt gönderildi',
    gonder: 'Gönder',
    gorenler: 'Görenler',
    kisiGordu: '{{sayi}} kişi gördü',
    gorenYok: 'Henüz kimse görmedi.',
    secenekler: 'Hikâye seçenekleri',
    sil: 'Hikâyeyi sil',
    silBaslik: 'Hikâye silinsin mi?',
    silAciklama: 'Hikâye herkes için kaldırılır. Bu işlem geri alınamaz.',
    silEvet: 'Sil',
    sonraki: 'Sonraki',
    onceki: 'Önceki',
    duraklat: 'Duraklat',
    kapat: 'Kapat',
    yukleniyor: 'Hikâye yükleniyor…',
    bulunamadi: 'Bu hikâye artık görünmüyor.',
  },
  ...
  sikayet: {
    ...
    altBaslikHikaye: 'Bu hikâyeyi neden şikâyet ediyorsun?',
  ...
  hatalar: {
    ...
    vt: {
      ayni_anda_en_fazla_10_hikayen_olabilir: 'Aynı anda en fazla 10 hikâyen olabilir.',
      hikaye_yazisi_en_fazla_200_karakter_olabilir: 'Hikâye yazısı en fazla 200 karakter olabilir.',
      bu_hikayeyi_sikayet_edemezsin: 'Bu hikâyeyi şikâyet edemezsin.',
      hikaye_bulunamadi: 'Hikâye bulunamadı.',
      ...
      kendi_anina_ifade_atamazsin: "Kendi anına ifade atamazsın.",
