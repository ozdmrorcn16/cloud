...
export default {
  ...
  bildirimler: {
    ...
    hikayeEtiketMetni: "anlığında seni etiketlemek istiyor.",
    hikayeEtiketMetniMekan: "{{mekan}} anlığında seni etiketlemek istiyor.",
  ...
  hikaye: {
    ...
    konumSec: "Konum seç",
    konumAraniyor: "Yakınındaki mekânlar aranıyor…",
    konumYok: "Yakınında mekân bulunamadı.",
    arsivBaslik: "Anlık arşivin",
    arsivAciklama: "Yalnızca sen görürsün. Anlıkların 24 saat sonra şeritten kalkar, burada kalır.",
    arsivBos: "Henüz bir anlığın yok.",
    arsivAc: "Anlık arşivini aç",
    canliKameraYok: "Canlı kamera için uygulamanın son sürümü gerekiyor. Yuvarlak tuşla yine fotoğraf çekebilirsin.",
    kameraIzniKapali: "Kamera izni kapalı.",
    izinVer: "İzin ver",
    ayarlariAc: "Ayarları aç",
    fotografSecBaslik: "Anlığa ekle",
    kamerayiAc: 'Kamerayı aç',
    galeriyiAc: 'Galerini aç',
    sonFotograflar: 'Son fotoğraflar',
    birFotografSec: 'Bir fotoğraf seç',
    fotografSecildi: '{{sayi}} fotoğraf seçildi',
    ileri: 'İleri',
    fotografSec: 'Fotoğraf seç',
    mekanEkle: 'Mekân',
    etiketle: 'Etiketle',
    gorunurlukSec: 'Kimler görebilir',
    arkadaslar: 'Arkadaşlar',
    herkese: 'Herkese',
    ifadeEkle: 'İfade',
    arkadasEkle: 'Arkadaş',
    ...
    dahaFazlaEmoji: "Daha fazla emoji",
    anligin: "Anlığın",
    kamera: 'Fotoğraf çek',
    galeri: 'Galeriden seç',
    kameraIzni: 'Fotoğraf çekmek için kamera izni gerekiyor.',
    yaziYerTutucu: 'Bir şeyler yaz…',
    mekanEtiketi: 'Mekân etiketi',
    mekanKaldir: 'Mekân etiketini kaldır',
    mekanIpucu: "Aktif bir check-in'in varsa mekân otomatik eklenir.",
    sureAciklama: "Anlığın 24 saat boyunca arkadaşlarına görünür.",
    paylas: 'Paylaş',
    ...
    gonder: 'Gönder',
    gorenler: 'Görenler',
    kisiGordu: '{{sayi}} kişi gördü',
    gorenYok: 'Henüz kimse görmedi.',
    secenekler: "Anlık seçenekleri",
    sil: "Anlığı sil",
    silBaslik: "Anlık silinsin mi?",
    silAciklama: "Anlık herkes için kaldırılır. Bu işlem geri alınamaz.",
    silEvet: 'Sil',
    sonraki: 'Sonraki',
    onceki: 'Önceki',
    duraklat: 'Duraklat',
    kapat: 'Kapat',
    yukleniyor: "Anlık yükleniyor…",
    bulunamadi: "Bu anlık artık görünmüyor.",
  },
  ...
  sikayet: {
    ...
    altBaslikHikaye: "Bu anlığı neden şikâyet ediyorsun?",
  ...
  hatalar: {
    ...
    vt: {
      ayni_anda_en_fazla_10_hikayen_olabilir: "Aynı anda en fazla 10 anlığın olabilir.",
      hikaye_yazisi_en_fazla_200_karakter_olabilir: "Anlık yazısı en fazla 200 karakter olabilir.",
      bu_hikayeyi_sikayet_edemezsin: "Bu anlığı şikâyet edemezsin.",
      hikaye_bulunamadi: "Anlık bulunamadı.",
      ...
      gecersiz_emoji: "Bu emoji kullanılamıyor.",
      kendi_anina_ifade_atamazsin: "Kendi anlığına ifade atamazsın.",
