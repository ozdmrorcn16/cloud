...
export default {
  ...
  etkilesim: {
    ...
    begenenler: 'Beğenenler',
    begenenYok: 'Henüz beğenen yok.',
    paylasimBaslik: 'Paylaşım',
    paylasimBulunamadi: 'Bu paylaşım artık görünmüyor.',
    yorumlar: 'Yorumlar',
  ...
  checkIn: {
    ...
    degistir: 'Değiştir',
    istegeBagli: 'Not, fotoğraf ve arkadaş eklemek isteğe bağlı.',
    notEtiket: 'Notun',
    notYerTutucu: 'Bu an hakkında bir şeyler yaz...',
    fotografEtiket: 'Fotoğraf',
    fotografEkle: 'Fotoğraf ekle',
    fotografKaldir: 'Fotoğrafı kaldır',
    arkadasEtiketle: 'Arkadaş etiketle',
    kimlerle: 'Kimlerle birliktesin?',
    birlikte: 'Birlikte',
    ekle: 'Ekle',
  ...
  bildirimAyarlari: {
    ...
    etkilesim: 'Beğeniler ve yorumlar',
    etkilesimAciklama: 'Paylaşımını beğenen ve yorum yapan kişiler',
