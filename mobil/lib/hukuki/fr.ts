  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Tes stories : la photo partagée, le texte facultatif, l’expression, les amis identifiés et le lieu. Pour chaque story, tu choisis qui peut la voir : « Amis » (par défaut) ou « Tout le monde » — une story « Tout le monde » peut être ouverte par tous dans l'application, même si ton profil est privé ; les personnes que tu as bloquées ne la voient en aucun cas. Une story est supprimée automatiquement, avec sa photo, au bout de 24 heures (aucune archive). Qui a vu ta story et quand est enregistré ; toi seul vois cette liste, et elle est supprimée avec la story. Tu peux supprimer une story toi-même à tout moment.",
      ],
    },
    {
