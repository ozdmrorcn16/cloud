  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Tes instants : la photo que tu prends sur le moment et, si tu as fait un check-in, le lieu. Pour chaque instant, tu choisis qui peut le voir : « Amis » (par défaut) ou « Tout le monde » — un instant « Tout le monde » peut être ouvert par tous dans l’application, même si ton profil est privé ; les personnes que tu as bloquées ne le voient en aucun cas. Un instant est supprimé automatiquement, avec sa photo, au bout de 24 heures (aucune archive). Qui a vu ton instant, quand, et quelle expression il y a envoyée est enregistré ; toi seul vois cette liste, et elle est supprimée avec l’instant. L’expression que tu envoies à l’instant de quelqu’un d’autre n’est vue que par son auteur. Tu peux supprimer un instant toi-même à tout moment.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Les instants et leurs enregistrements de vues sont supprimés, avec la photo, 24 heures après la publication par une tâche de nettoyage horaire. Cette règle est EN VIGUEUR aujourd’hui.",
      ],
    },
    {
      baslik: '7. Tes droits',
