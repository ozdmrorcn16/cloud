  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Où tu habites : pays et, en Türkiye, province et district. Demandé à la création du compte ; jamais lu sur l'appareil, tu le choisis toi-même. Il n'apparaît jamais sur ton profil ni ailleurs dans l'application et n'est jamais transmis aux autres utilisateurs ; il est seulement conservé avec ton compte et inclus dans ton fichier « Télécharger mes données ». Finalité : savoir dans quelles régions développer le service.",
        ...
        "Tes instants : la photo que tu prends sur le moment et, si tu as fait un check-in, le lieu. Pour chaque instant, tu choisis qui peut le voir : « Amis » (par défaut) ou « Tout le monde » — un instant « Tout le monde » peut être ouvert par tous dans l’application, même si ton profil est privé ; les personnes que tu as bloquées ne le voient en aucun cas. Au bout de 24 heures, un instant quitte la barre et toi seul le vois encore : sa photo et son lieu restent dans ton archive d’instants jusqu’à ce que tu le supprimes ou que tu supprimes ton compte. Qui a vu ton instant, quand, et quelle expression il y a laissée est enregistré ; toi seul vois cette liste, et elle est supprimée au bout de 24 heures. L’expression que tu laisses sur l’instant de quelqu’un d’autre n’est vue que par son auteur ; ta réponse lui arrive comme message de discussion. Tu peux supprimer un instant toi-même à tout moment.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Les e-mails de vérification (codes d\'inscription, de connexion et de suppression de compte) sont envoyés par Resend Inc. ; ses serveurs sont en Irlande (région eu-west-1, Union européenne). Seuls ton adresse e-mail et le code envoyé y transitent ; le code expire au bout d\'une heure.',
        ...
        "Base légale du transfert : les quatre transferts sont nécessaires à la fourniture du service, ils reposent donc sur la même base qu'à la section 2, l'exécution du contrat ; l'envoi de notifications relève en outre de l'intérêt légitime.",
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Les enregistrements de vues, les expressions laissées et les identifications des instants sont supprimés 24 heures après la publication par une tâche de nettoyage horaire ; la photo et le lieu restent dans l’archive que toi seul vois. Cette règle est EN VIGUEUR aujourd’hui.",
      ],
    },
    {
      baslik: '7. Tes droits',
  ...
  kosullar: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Ton nom d'utilisateur est unique et doit respecter un format précis (minuscules, chiffres, point et tiret bas ; 3 à 20 caractères). Tu peux changer ton nom d'utilisateur une fois toutes les 24 heures.",
