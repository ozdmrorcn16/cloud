  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Les enregistrements de vues, les expressions envoyées et les identifications des instants sont supprimés 24 heures après la publication par une tâche de nettoyage horaire ; la photo et le lieu restent dans l’archive que toi seul vois. Cette règle est EN VIGUEUR aujourd’hui.",
      ],
    },
    {
      baslik: '7. Tes droits',
