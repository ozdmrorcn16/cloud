  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Anlıkların görüntülenme kayıtları ve etiketler paylaşımdan 24 saat sonra her saat çalışan bir temizlik işiyle silinir; anlığın fotoğrafı ve mekânı yalnızca senin görebildiğin arşivde kalır. Bu kural bugün YÜRÜRLÜKTEDİR.",
      ],
    },
    {
      baslik: '7. Hakların',
