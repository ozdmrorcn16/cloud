  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Oturduğun bölge: ülke, Türkiye'de ayrıca il ve ilçe. Hesap açarken sorulur. Cihazından okunmaz, kendin seçersin. Profilinde ya da uygulamanın başka bir yerinde hiçbir zaman gösterilmez, başka kullanıcılara aktarılmaz; yalnızca hesabınla birlikte saklanır ve \"Verilerimi indir\" dosyanda yer alır. Amaç: hizmeti hangi bölgelerde geliştireceğimizi bilmek.",
        ...
        "Anlıkların: anlık çektiğin fotoğraf ve check-in yaptıysan mekân etiketi. Her anlıkta kimlerin görebileceğini sen seçersin: \"Arkadaşlar\" (varsayılan) ya da \"Herkese\" — \"Herkese\" seçtiğin anlığı profilin gizli olsa da uygulamadaki herkes açabilir, engellediğin kişiler hiçbir hâlde göremez. Anlık 24 saat sonra şeritten kalkar ve artık yalnızca sen görürsün: fotoğrafı ve mekânı senin anlık arşivinde, sen silene ya da hesabını silene kadar saklanır. Kimin anlığını ne zaman gördüğü ve anlığına hangi ifadeyi bıraktığı kaydedilir; bu listeyi yalnızca sen görürsün ve 24 saat dolunca silinir. Başkasının anlığına bıraktığın ifadeyi yalnızca o anlığın sahibi görür; yazdığın yanıt ise sohbette mesaj olarak gider. Bir anlığı dilediğin an kendin silebilirsin.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Doğrulama postalarını (kayıt, giriş, hesap silme kodları) Resend Inc. gönderir; sunucuları İrlanda\'da (eu-west-1 bölgesi, Avrupa Birliği). Buraya yalnızca e-posta adresin ve gönderilen kod geçer; kod 10 dakika içinde geçersiz olur.',
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Anlıkların görüntülenme kayıtları, bırakılan ifadeler ve etiketler paylaşımdan 24 saat sonra her saat çalışan bir temizlik işiyle silinir; anlığın fotoğrafı ve mekânı yalnızca senin görebildiğin arşivde kalır. Bu kural bugün YÜRÜRLÜKTEDİR.",
      ],
    },
    {
      baslik: '7. Hakların',
