  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Hikâyelerin: paylaştığın fotoğraf, isteğe bağlı yazı, ifade, arkadaş etiketi ve mekân etiketi. Her hikâyede kimlerin görebileceğini sen seçersin: "Arkadaşlar" (varsayılan) ya da "Herkese" — "Herkese" seçtiğin hikâyeyi profilin gizli olsa da uygulamadaki herkes açabilir, engellediğin kişiler hiçbir hâlde göremez. Hikâye 24 saat sonra fotoğrafıyla birlikte otomatik silinir (arşiv tutulmaz). Kimin hikâyeni ne zaman gördüğü kaydedilir; bu listeyi yalnızca sen görürsün ve hikâye silinince o kayıt da silinir. Bir hikâyeyi dilediğin an kendin silebilirsin.',
      ],
    },
    {
