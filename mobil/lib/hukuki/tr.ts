  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Hikâyelerin: paylaştığın fotoğraf, isteğe bağlı yazı, ifade, arkadaş etiketi ve mekân etiketi. Hikâye yalnızca arkadaşlarına görünür ve 24 saat sonra fotoğrafıyla birlikte otomatik silinir (arşiv tutulmaz). Kimin hikâyeni ne zaman gördüğü kaydedilir; bu listeyi yalnızca sen görürsün ve hikâye silinince o kayıt da silinir. Bir hikâyeyi dilediğin an kendin silebilirsin.',
      ],
    },
    {
