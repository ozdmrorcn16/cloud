  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Deine Momente: das Foto, das du direkt aufnimmst, und – falls du eingecheckt hast – die Ortsmarkierung. Für jeden Moment wählst du selbst, wer ihn sehen darf: \"Freunde\" (Standard) oder \"Alle\" — einen Moment mit \"Alle\" können alle in der App öffnen, auch wenn dein Profil privat ist; von dir blockierte Personen sehen ihn in keinem Fall. Nach 24 Stunden verschwindet ein Moment aus der Leiste und nur du siehst ihn noch: Foto und Ort bleiben in deinem Moment-Archiv, bis du ihn oder dein Konto löschst. Wer deinen Moment wann gesehen und welches Emoji er dort hinterlassen hat, wird erfasst; nur du siehst diese Liste, und sie wird nach 24 Stunden gelöscht. Ein Emoji, das du beim Moment einer anderen Person hinterlässt, sieht nur deren Inhaber; eine Antwort geht als Chatnachricht an ihn. Du kannst einen Moment jederzeit selbst löschen.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Ansichtsprotokolle, hinterlassene Emojis und Markierungen von Momenten werden 24 Stunden nach dem Teilen durch einen stündlichen Bereinigungslauf gelöscht; Foto und Ort bleiben im Archiv, das nur du siehst. Diese Regel ist heute IN KRAFT.",
      ],
    },
    {
