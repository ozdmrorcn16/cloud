  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Bestätigungs-E-Mails (Codes für Registrierung, Anmeldung und Kontolöschung) versendet Resend Inc.; die Server stehen in Irland (Region eu-west-1, Europäische Union). Dorthin gelangen nur deine E-Mail-Adresse und der gesendete Code; der Code verfällt innerhalb einer Stunde.',
