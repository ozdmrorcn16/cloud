  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Deine Momente: das Foto, das du direkt aufnimmst, und – falls du eingecheckt hast – die Ortsmarkierung. Für jeden Moment wählst du selbst, wer ihn sehen darf: \"Freunde\" (Standard) oder \"Alle\" — einen Moment mit \"Alle\" können alle in der App öffnen, auch wenn dein Profil privat ist; von dir blockierte Personen sehen ihn in keinem Fall. Ein Moment wird nach 24 Stunden zusammen mit seinem Foto automatisch gelöscht (kein Archiv). Wer deinen Moment wann gesehen und welche Stimmung er dazu geschickt hat, wird erfasst; nur du siehst diese Liste, und sie wird mit dem Moment gelöscht. Eine Stimmung, die du zum Moment einer anderen Person schickst, sieht nur deren Inhaber. Du kannst einen Moment jederzeit selbst löschen.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Momente und ihre Ansichtsprotokolle werden 24 Stunden nach dem Teilen durch einen stündlichen Bereinigungslauf zusammen mit dem Foto gelöscht. Diese Regel ist heute IN KRAFT.",
      ],
    },
    {
