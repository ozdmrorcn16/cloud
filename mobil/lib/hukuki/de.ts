...
const de: HukukiMetin = {
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Dein Wohnort: Land, in der Türkei zusätzlich Provinz und Bezirk. Wird beim Erstellen des Kontos abgefragt; nie vom Gerät gelesen, du wählst selbst. Er wird nie in deinem Profil oder sonst in der App angezeigt und nie an andere Nutzer weitergegeben; er wird nur mit deinem Konto gespeichert und ist in deiner Datei „Meine Daten herunterladen“ enthalten. Zweck: wissen, in welchen Regionen wir den Dienst ausbauen.",
        ...
        "Deine Momente: das Foto, das du direkt aufnimmst, und – falls du eingecheckt hast – die Ortsmarkierung. Für jeden Moment wählst du selbst, wer ihn sehen darf: \"Freunde\" (Standard) oder \"Alle\" — einen Moment mit \"Alle\" können alle in der App öffnen, auch wenn dein Profil privat ist; von dir blockierte Personen sehen ihn in keinem Fall. Nach 24 Stunden verschwindet ein Moment aus der Leiste und nur du siehst ihn noch: Foto und Ort bleiben in deinem Moment-Archiv, bis du ihn oder dein Konto löschst. Wer deinen Moment wann gesehen und welche Stimmung er dort hinterlassen hat, wird erfasst; nur du siehst diese Liste, und sie wird nach 24 Stunden gelöscht. Eine Stimmung, die du beim Moment einer anderen Person hinterlässt, sieht nur deren Inhaber; eine Antwort geht als Chatnachricht an ihn. Du kannst einen Moment jederzeit selbst löschen.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Bestätigungs-E-Mails (Codes für Registrierung, Anmeldung und Kontolöschung) versendet Resend Inc.; die Server stehen in Irland (Region eu-west-1, Europäische Union). Dorthin gelangen nur deine E-Mail-Adresse und der gesendete Code; der Code verfällt innerhalb von 10 Minuten.',
        ...
        'Rechtsgrundlage der Übermittlung: Alle vier Übermittlungen sind für die Erbringung des Dienstes notwendig, stützen sich also auf dieselbe Grundlage wie in Abschnitt 2 - die Vertragserfüllung; die Zustellung von Benachrichtigungen fällt zusätzlich unter das berechtigte Interesse.',
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Ansichtsprotokolle, hinterlassene Stimmungen und Markierungen von Momenten werden 24 Stunden nach dem Teilen durch einen stündlichen Bereinigungslauf gelöscht; Foto und Ort bleiben im Archiv, das nur du siehst. Diese Regel ist heute IN KRAFT.",
      ],
    },
    {
  ...
  kosullar: [
    ...
    },
    {
      baslik: '6. Inhalte',
      paragraflar: [
        'Die Notiz, der Stimmungsausdruck und das Foto, die du einem Check-in hinzufügst, gehören dir. Indem du sie teilst, erlaubst du Slooin, diesen Inhalt innerhalb der App anzuzeigen (im Feed, in deinem Profil, auf der Seite des betreffenden Ortes). Das Eigentum am Inhalt bleibt bei dir.',
      ],
    },
    {
      baslik: '7. Moderation',
