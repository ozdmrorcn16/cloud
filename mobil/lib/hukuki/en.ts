  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Your moments: the photo you take on the spot and, if you have checked in, the place tag. For each moment you choose who can see it: \"Friends\" (the default) or \"Everyone\" - a moment set to \"Everyone\" can be opened by anyone in the app even if your profile is private, and people you have blocked can never see it. A moment is deleted automatically, together with its photo, after 24 hours (no archive is kept). Who viewed your moment, when, and which expression they sent to it is recorded; only you see that list, and it is deleted with the moment. An expression you send to someone else’s moment is seen only by that moment’s owner. You can delete a moment yourself at any time.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Moments and their view records are deleted, together with the photo, 24 hours after posting by an hourly cleanup job. This rule is IN EFFECT today.",
      ],
    },
    {
