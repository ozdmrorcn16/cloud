  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Your stories: the photo you share, the optional text, expression, friend tags and place tag. A story is visible only to your friends and is deleted automatically, together with its photo, after 24 hours (no archive is kept). Who viewed your story and when is recorded; only you see that list, and it is deleted with the story. You can delete a story yourself at any time.',
      ],
    },
    {
