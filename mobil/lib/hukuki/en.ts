  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Verification e-mails (sign-up, sign-in and account deletion codes) are sent by Resend Inc.; its servers are in Ireland (eu-west-1 region, European Union). Only your e-mail address and the code sent pass through here; the code expires within one hour.',
