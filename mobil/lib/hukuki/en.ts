  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Your moments: the photo you take on the spot and, if you have checked in, the place tag. For each moment you choose who can see it: \"Friends\" (the default) or \"Everyone\" - a moment set to \"Everyone\" can be opened by anyone in the app even if your profile is private, and people you have blocked can never see it. After 24 hours a moment leaves the strip and only you can see it: its photo and place stay in your moments archive until you delete it or your account. Who viewed your moment, when, and which expression they left on it is recorded; only you see that list, and it is deleted after 24 hours. An expression you leave on someone else’s moment is seen only by that moment’s owner; a reply you write goes to them as a chat message. You can delete a moment yourself at any time.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Verification e-mails (sign-up, sign-in and account deletion codes) are sent by Resend Inc.; its servers are in Ireland (eu-west-1 region, European Union). Only your e-mail address and the code sent pass through here; the code expires within 10 minutes.',
        ...
        'Legal basis of the transfer: all four transfers are necessary to provide the service, so they rest on the same basis as in section 2 - performance of a contract; notification delivery additionally falls under legitimate interest.',
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "View records, expressions left and tags on moments are deleted 24 hours after posting by an hourly cleanup job; the photo and place stay in the archive only you can see. This rule is IN EFFECT today.",
      ],
    },
    {
