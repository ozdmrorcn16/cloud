  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Tus momentos: la foto que haces en el momento y, si has hecho check-in, la etiqueta de lugar. En cada momento eliges quién puede verlo: \"Amigos\" (por defecto) o \"Todos\" — un momento \"Todos\" puede abrirlo cualquiera en la app, aunque tu perfil sea privado; las personas a las que has bloqueado no lo ven en ningún caso. A las 24 horas un momento sale de la barra y solo tú lo ves: su foto y su lugar se quedan en tu archivo de momentos hasta que lo elimines o elimines tu cuenta. Se registra quién vio tu momento y cuándo; solo tú ves esa lista, y se elimina a las 24 horas. Una reacción con emoji o una respuesta a un momento llega a su dueño como mensaje de chat. Puedes eliminar un momento tú mismo cuando quieras.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Los registros de visualización y las etiquetas de los momentos se eliminan 24 horas después de publicarse mediante una tarea de limpieza que se ejecuta cada hora; la foto y el lugar se quedan en el archivo que solo tú ves. Esta regla está EN VIGOR hoy.",
      ],
    },
    {
