  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Los correos de verificación (códigos de registro, inicio de sesión y eliminación de cuenta) los envía Resend Inc.; sus servidores están en Irlanda (región eu-west-1, Unión Europea). Por aquí solo pasan tu dirección de correo y el código enviado; el código caduca en una hora.',
