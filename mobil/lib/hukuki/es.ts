  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Tus historias: la foto que compartes, el texto opcional, la expresión, las etiquetas de amigos y la etiqueta de lugar. En cada historia eliges quién puede verla: "Amigos" (por defecto) o "Todos" — una historia "Todos" puede abrirla cualquiera en la app, aunque tu perfil sea privado; las personas a las que has bloqueado no la ven en ningún caso. Una historia se elimina automáticamente, junto con su foto, a las 24 horas (no se guarda archivo). Se registra quién vio tu historia y cuándo; solo tú ves esa lista, y se elimina con la historia. Puedes eliminar una historia tú mismo en cualquier momento.',
      ],
    },
    {
