...
const es: HukukiMetin = {
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Dónde vives: país y, en Türkiye, también provincia y distrito. Se pregunta al crear la cuenta; nunca se lee del dispositivo, lo eliges tú. Nunca se muestra en tu perfil ni en ningún otro lugar de la app, ni se pasa a otros usuarios; solo se guarda con tu cuenta y se incluye en tu archivo de \"Descargar mis datos\". Finalidad: saber en qué regiones desarrollar el servicio.",
        ...
        "Tus momentos: la foto que haces en el momento y, si has hecho check-in, la etiqueta de lugar. En cada momento eliges quién puede verlo: \"Amigos\" (por defecto) o \"Todos\" — un momento \"Todos\" puede abrirlo cualquiera en la app, aunque tu perfil sea privado; las personas a las que has bloqueado no lo ven en ningún caso. A las 24 horas un momento sale de la barra y solo tú lo ves: su foto y su lugar se quedan en tu archivo de momentos hasta que lo elimines o elimines tu cuenta. Se registra quién vio tu momento, cuándo y qué expresión dejó; solo tú ves esa lista, y se elimina a las 24 horas. La expresión que dejas en el momento de otra persona solo la ve su dueño; la respuesta que escribes le llega como mensaje de chat. Puedes eliminar un momento tú mismo cuando quieras.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Los correos de verificación (códigos de registro, inicio de sesión y eliminación de cuenta) los envía Resend Inc.; sus servidores están en Irlanda (región eu-west-1, Unión Europea). Por aquí solo pasan tu dirección de correo y el código enviado; el código caduca en 10 minutos.',
        ...
        'Base legal de la transferencia: las cuatro transferencias son necesarias para prestar el servicio, así que se apoyan en la misma base del apartado 2, la ejecución del contrato; el envío de notificaciones además entra en el interés legítimo.',
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Los registros de visualización, las expresiones dejadas y las etiquetas de los momentos se eliminan 24 horas después de publicarse mediante una tarea de limpieza que se ejecuta cada hora; la foto y el lugar se quedan en el archivo que solo tú ves. Esta regla está EN VIGOR hoy.",
      ],
    },
    {
  ...
  kosullar: [
    ...
    },
    {
      baslik: '6. Contenido',
      paragraflar: [
        'La nota, la expresión de estado y la foto que añades a un check-in son tuyas. Al compartirlas concedes a Slooin permiso para mostrar ese contenido dentro de la app (en el feed, en tu perfil, en la página del lugar correspondiente). La propiedad del contenido sigue siendo tuya.',
      ],
    },
    {
      baslik: '7. Moderación',
