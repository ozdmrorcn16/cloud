  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        'Tus historias: la foto que compartes, el texto opcional, la expresión, las etiquetas de amigos y la etiqueta de lugar. Una historia solo la ven tus amigos y se elimina automáticamente, junto con su foto, a las 24 horas (no se guarda archivo). Se registra quién vio tu historia y cuándo; solo tú ves esa lista, y se elimina con la historia. Puedes eliminar una historia tú mismo en cualquier momento.',
      ],
    },
    {
