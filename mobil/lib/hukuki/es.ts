  ...
  gizlilik: [
    ...
    },
    {
      ...
      paragraflar: [
        ...
        "Los registros de visualización, las expresiones enviadas y las etiquetas de los momentos se eliminan 24 horas después de publicarse mediante una tarea de limpieza que se ejecuta cada hora; la foto y el lugar se quedan en el archivo que solo tú ves. Esta regla está EN VIGOR hoy.",
      ],
    },
    {
