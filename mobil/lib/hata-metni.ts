...
const VERITABANI: Record<string, string> = {
  ...
  'Hikaye yazisi en fazla 200 karakter olabilir': 'hikaye_yazisi_en_fazla_200_karakter_olabilir',
  'Bu hikayeyi sikayet edemezsin': 'bu_hikayeyi_sikayet_edemezsin',
  'Hikaye bulunamadi': 'hikaye_bulunamadi',
