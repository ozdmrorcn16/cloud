 ...
 *
 * Ekranda iki kademe gosteriliyor: herkese acik ve sadece takipcilerim.
 * 'gizli' kademesi arayuzden kaldirildi ama sunucuda duruyor; eski
...
export default function CheckInGorunurluguEkrani() {
  ...
  const SECENEKLER: { deger: Bulunurluk; etiket: string }[] = [
    { deger: 'herkese_acik', etiket: t('ayarlar.bulunurlukHerkeseAcik') },
    { deger: 'takipcilerim', etiket: t('ayarlar.bulunurlukTakipcilerim') },
  ]
