...
export const BOLUMLER: { baslik: string; paragraflar: string[] }[] = [
  ...
  },
  {
    ...
    paragraflar: [
      ...
      'Check-in yaptığında: check-in AKTİFKEN koordinatın saklanır. Ama bu geçici: check-in süresi dolduğunda (ya da hemen "ayrıldım" dediğinde) otomatik olarak anıya dönüşür, ve bu dönüşümde koordinat SİLİNİR (veritabanında null\'a çekilir) - geriye yalnızca hangi mekanda olduğun kalır, tam koordinat değil.',
