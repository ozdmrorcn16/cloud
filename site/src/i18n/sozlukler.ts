...
const tr: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    betik: {
      ...
      kodGonderildi: "Onay kodu e-postana gönderildi. Kod bir saat geçerli.",
...
const en: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    betik: {
      ...
      kodGonderildi: "The confirmation code was sent to your e-mail. It is valid for one hour.",
...
const de: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    betik: {
      ...
      kodGonderildi: "Der Bestätigungscode wurde an deine E-Mail gesendet. Er ist eine Stunde gültig.",
...
const es: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    betik: {
      ...
      kodGonderildi: "El código de confirmación se envió a tu correo. Es válido durante una hora.",
...
const fr: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    betik: {
      ...
      kodGonderildi: "Le code de confirmation a été envoyé à ton e-mail. Il est valable une heure.",
...
const ru: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    betik: {
      ...
      kodGonderildi: "Код подтверждения отправлен на вашу почту. Он действует один час.",
...
const ar: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    betik: {
      ...
      kodGonderildi: "أُرسل رمز التأكيد إلى بريدك الإلكتروني. وهو صالح لمدة ساعة واحدة.",
