...
const tr: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    silBaslik: 'Sil',
    silAciklama:
      'Güvenlik için parolan isteniyor. Parolan sunucuda doğrulanır; bu sayfanın hesabın üzerinde hiçbir yetkisi yoktur.',
...
const en: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    silBaslik: 'Delete',
    silAciklama: 'Your password is required for security. It is verified on the server; this page has no authority over your account.',
    epostaEtiket: 'E-mail',
    ...
    betik: {
      ...
      girisHatasi: 'Could not sign in. The e-mail or password may be wrong. If you created your account without a password, write to destek@slooin.com.',
      cokDeneme: 'This attempt was blocked because of too many tries. Wait a few minutes and try again.',
      girisTamamlanamadi: 'Sign-in could not be completed right now. Try again in a few minutes; if the problem persists write to destek@slooin.com.',
...
const de: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    silBaslik: 'Löschen',
    silAciklama: 'Aus Sicherheitsgründen wird dein Passwort abgefragt. Es wird auf dem Server geprüft; diese Seite hat keinerlei Befugnis über dein Konto.',
    epostaEtiket: 'E-Mail',
    ...
    betik: {
      ...
      girisHatasi: 'Anmeldung nicht möglich. E-Mail oder Passwort könnten falsch sein. Wenn du dein Konto ohne Passwort erstellt hast, schreib an destek@slooin.com.',
      cokDeneme: 'Dieser Versuch wurde wegen zu vieler Versuche blockiert. Warte ein paar Minuten und versuche es erneut.',
      girisTamamlanamadi: 'Die Anmeldung konnte gerade nicht abgeschlossen werden. Versuche es in ein paar Minuten erneut; besteht das Problem weiter, schreib an destek@slooin.com.',
...
const es: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    silBaslik: 'Eliminar',
    silAciklama: 'Por seguridad se pide tu contraseña. Se verifica en el servidor; esta página no tiene ninguna autoridad sobre tu cuenta.',
    ...
    betik: {
      ...
      girisHatasi: 'No se pudo iniciar sesión. El correo o la contraseña pueden ser incorrectos. Si creaste tu cuenta sin contraseña, escribe a destek@slooin.com.',
      cokDeneme: 'Este intento se bloqueó por demasiados intentos. Espera unos minutos y vuelve a intentarlo.',
      girisTamamlanamadi: 'No se pudo completar el inicio de sesión ahora. Inténtalo de nuevo en unos minutos; si el problema continúa, escribe a destek@slooin.com.',
...
const fr: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    silBaslik: 'Supprimer',
    silAciklama: "Ton mot de passe est demandé par sécurité. Il est vérifié sur le serveur ; cette page n'a aucune autorité sur ton compte.",
    epostaEtiket: 'E-mail',
    ...
    betik: {
      ...
      girisHatasi: "Connexion impossible. L'e-mail ou le mot de passe est peut-être incorrect. Si tu as créé ton compte sans mot de passe, écris à destek@slooin.com.",
      cokDeneme: 'Cette tentative a été bloquée en raison d\'un trop grand nombre d\'essais. Attends quelques minutes et réessaie.',
      girisTamamlanamadi: "La connexion n'a pas pu aboutir pour le moment. Réessaie dans quelques minutes ; si le problème persiste, écris à destek@slooin.com.",
...
const ru: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    silBaslik: 'Удалить',
    silAciklama: 'Для безопасности запрашивается пароль. Он проверяется на сервере; эта страница не имеет никаких полномочий над вашим аккаунтом.',
    ...
    betik: {
      ...
      girisHatasi: 'Не удалось войти. Возможно, почта или пароль неверны. Если вы создали аккаунт без пароля, напишите на destek@slooin.com.',
      cokDeneme: 'Попытка заблокирована из-за слишком большого числа попыток. Подождите несколько минут и попробуйте снова.',
      girisTamamlanamadi: 'Вход сейчас не удалось завершить. Попробуйте через несколько минут; если проблема сохраняется, напишите на destek@slooin.com.',
...
const ar: SiteSozlugu = {
  ...
  hesapSil: {
    ...
    silBaslik: 'حذف',
    silAciklama: 'تُطلب كلمة المرور لأغراض الأمان. يُتحقَّق منها على الخادم؛ ولا تملك هذه الصفحة أي صلاحية على حسابك.',
    ...
    betik: {
      ...
      girisHatasi: 'تعذّر تسجيل الدخول. قد يكون البريد أو كلمة المرور خاطئًا. إذا أنشأت حسابك دون كلمة مرور فاكتب إلى destek@slooin.com.',
      cokDeneme: 'حُظرت هذه المحاولة بسبب كثرة المحاولات. انتظر بضع دقائق ثم حاول مجددًا.',
      girisTamamlanamadi: 'تعذّر إكمال تسجيل الدخول الآن. حاول بعد بضع دقائق؛ وإذا استمرت المشكلة فاكتب إلى destek@slooin.com.',
